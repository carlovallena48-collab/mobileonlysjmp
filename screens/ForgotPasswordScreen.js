...
export default function ForgotPasswordScreen({ navigation }) {
    ...
    const handleSendVerificationCode = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://10.173.231.17:5000/api/forgot-password', {
    ...
    const handleVerifyCode = async (code = null) => {
        ...
        try {
            ...
            const response = await axios.post('http://10.173.231.17:5000/api/verify-reset-code', {
                email: userEmail,
    ...
    const handleResendCode = async () => {
        setLoading(true);
        try {
            await axios.post('http://10.173.231.17:5000/api/forgot-password', {
                email: userEmail,
            });
